...
enum DebugFlag {DEBUG_SYSTEM, DEBUG_NETWORK, DEBUG_LOBBY_NETWORK, DEBUG_MATCH_NETWORK, DEBUG_QUEUE_NETWORK, DEBUG_MENUS, DEBUG_MAP, DEBUG_LOBBY, DEBUG_INPUT, DEBUG_DISPLAY_CMD, DEBUG_LOGIC_CMD, DEBUG_EFFECT, DEBUG_MATCH}
...
const debug_flag_array = [ MATCH, SYSTEM, MATCH_NETWORK, EFFECT ]
