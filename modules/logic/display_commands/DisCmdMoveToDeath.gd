...
func execute():
	Terminal.add_log(Debug.ALL, Debug.DISPLAY_CMD, "[%s] DisCmdMoveToDeath %s" % [object_logic.get_name_id(), object_logic.hex.coords.to_str()])
